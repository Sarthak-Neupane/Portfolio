<template>
    <BaseProject>
        ...
        <template #para2> The project started off with filling the database with several clubs and
            players.
            Currently consists <span class="secondary">150+ football clubs</span> and <span class="secondary">1000+ players</span>. Each player document consists of a
        ...
        <template #para3>The frontend consists of <span class="secondary">2 static routes</span> and a <span class="secondary">dynamic route</span> <span class="third">(the
                game route)</span>. The Home page consist a how-to-play and a find-a-game buttons. On
            clicking
            the find-a-game button, the app calls a socket event to switch the user into a <span class="secondary">lobby</span>.
        ...
        <template #para4> The players are now pushed to a new dynamic route. On entering the route, the
            app
            hits a <span class="secondary">api route</span> to fill the game data. The api <span class="third">(existing in the server
                directory)</span> now runs few <span class="secondary">algorithms</span> to find out a random set of clubs <span class="third">
        ...
        <template #para5> Each player now <span class="secondary">takes their turn</span> one after the other. If the guess is correct,
            one
            box in the grid, which corresponds to the current answer, <span class="secondary">fills</span> with the current player's color
        ...
        <template #para6> The app runs an <span class="secondary">algorithm</span> to check if there is a winner, after the initial 3
            rounds
            are played. After the winner is found, a socket event is fired to let both players know the
            ending
            of the game. The UI now displays <span class="secondary">return-home</span> and <span class="secondary">play-again</span> buttons. The play-again buttons
            fires a
