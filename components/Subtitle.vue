<template>
    <div
        class="w-full h-full flex flex-col justify-center items-center gap-2 2xl:gap-4 4xl:gap-8 6xl:gap-12 text-[#FFFEFF] py-5 md:py-8 lg:py-8 2xl:py-10 4xl:py-16 6xl:py-28">
